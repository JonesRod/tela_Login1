...
<body>
    ...
    <form action="" method="POST">
        ...
        <p>
            ...
            <input id="ee" value="<?php if(isset($_POST['senhaAtual'])) echo $_POST['senhaAtual']; ?>" type="password" name="senhaAtual">
        </p>
        <p>
            <label for="">Nova Senha: </label>
            <input placeholder="Minimo 8 digitos" value="<?php if(isset($_POST['novaSenha'])) echo $_POST['novaSenha']; ?>" type="password" name="novaSenha">
        </p>
        <p>
